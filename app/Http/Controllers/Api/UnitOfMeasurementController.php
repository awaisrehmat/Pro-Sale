...
class UnitOfMeasurementController extends Controller {
    ...
    private function rules(?UnitOfMeasurement $unit=null):array{return ['name'=>['required','string','max:80',TenantRule::unique('units_of_measurement','name')->ignore($unit)],'symbol'=>['required','string','max:20',TenantRule::unique('units_of_measurement','symbol')->ignore($unit)],'decimal_places'=>'required|integer|min:0|max:3','is_active'=>'boolean'];}
