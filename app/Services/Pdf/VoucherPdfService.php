    ...
    public function generate(Payment $payment): string
    {
        ...
        $pdf = new class extends FPDF {
            public function Footer(): void
            {
                ...
                $this->Cell(0, 5, 'Generated by Stock Manager  |  Page '.$this->PageNo(), 0, 0, 'C');
            }
        };
        ...
        $pdf->SetXY(15, 19);
        $pdf->Cell(15, 5, 'SM', 0, 0, 'C');

        $pdf->SetXY(35, 15);
        $pdf->SetTextColor(16, 24, 40);
        $pdf->SetFont('Arial', 'B', 15);
        $pdf->Cell(90, 7, 'Stock Manager', 0, 1);
        $pdf->SetX(35);
        $pdf->SetFont('Arial', '', 8);
        $pdf->SetTextColor(102, 112, 133);
        $pdf->Cell(90, 5, 'Procurement, Sales and Inventory', 0, 0);
