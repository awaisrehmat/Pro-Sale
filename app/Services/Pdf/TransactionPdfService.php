    ...
    private function generate(Purchase|Sale $transaction, bool $purchase): string
    {
        ...
        $pdf = new class extends FPDF {
            ...
            public function Header(): void
            {
                ...
                $this->Cell(14, 5, 'SM', 0, 0, 'C');

                $this->SetXY(34, 12);
                $this->SetTextColor(16, 24, 40);
                $this->SetFont('Arial', 'B', 14);
                $this->Cell(80, 7, 'Stock Manager', 0, 1);
                $this->SetX(34);
                $this->SetTextColor(102, 112, 133);
                $this->SetFont('Arial', '', 7);
                $this->Cell(80, 5, 'Procurement, Sales and Inventory', 0, 0);
            ...
            public function Footer(): void
            {
                ...
                $this->Cell(0, 5, 'Generated by Stock Manager  |  Page '.$this->PageNo().' of {nb}', 0, 0, 'C');
            }
        };
