...
class Product extends Model {
    use SoftDeletes;
    protected $guarded = [];
    protected $appends = ['category_name', 'subcategory_name', 'uom_name'];
    ...
    public function unitOfMeasurement() { return $this->belongsTo(UnitOfMeasurement::class); }
    ...
    public function getUomNameAttribute() { return $this->unitOfMeasurement?->name; }
}
