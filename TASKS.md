...
- [x] Create reports
  - Includes report-specific summaries and filters, status indicators, CSV export, print styling, payment-channel cash flow, receivables/payables, and auditable product-wise stock movement history.
